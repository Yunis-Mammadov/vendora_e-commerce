...
export default function NewSectionMan() {
    ...
    const items = Array(6).fill("NEW IN MAN");

    const cards = Array(3).fill({
        imgFront:
            "https://www.duelunecalzature.com/ecommerce/wp-content/uploads/2025/03/MLIAM-TESTA-DI-MORO.jpg",
        imgBack:
            "https://www.duelunecalzature.com/ecommerce/wp-content/uploads/2025/03/MLIAM-TESTA-DI-MORO-1.jpg",
        name: "NAME",
        price: "PRICE",
    });
